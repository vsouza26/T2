...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOKEN_OPENK = 56,               /* TOKEN_OPENK  */
  YYSYMBOL_TOKEN_OPENC = 57,               /* TOKEN_OPENC  */
...
static const char *const yytname[] =
{
  ...
  "TOKEN_DOT_COMMA", "TOKEN_COMMA", "TOKEN_OPENP", "TOKEN_OPENK",
  "TOKEN_OPENC", "TOKEN_RETURN", "$accept", "program", YY_NULLPTR
};
